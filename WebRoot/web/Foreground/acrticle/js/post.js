$(document).ready(function(){
    ...
    $('.entry a').each(function(index,element){
        ...
        if(href){
            if(href.indexOf('#') == 0){
            }else if ( href.indexOf('/') == 0 || href.toLowerCase().indexOf('http://histoire.xyz/js/beiyuu.com')>-1 ){
    ...
    $.getScript('prettify.js'/*tpa=http://histoire.xyz/js/prettify/prettify.js*/,function(){
        prettyPrint();
    });
    ...
    if(/css3-animation/.test(location.href)){
        $("head").append("<link rel='stylesheet' type='text/css' href='css3-ani.css'/*tpa=http://histoire.xyz/css/css3-ani.css*//>");
        $.getScript('css3-ani.js'/*tpa=http://histoire.xyz/js/css3-ani.js*/,function(){});
    }
});
