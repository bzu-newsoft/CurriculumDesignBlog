...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() { 
				$.ajax({url:"RecycleServlet?method=select",success:function(result){
				      $("#divSelectPublish").html(result);
				    }});
				$("#InsertButton").click(function() {
					$.ajax({url:"RecycleServlet?method=insert&id="+$("#id").val()
														+"&title="+$("#title").val()
														+"&path="+$("#path").val()
														+"&type="+$("#type").val()
				...
				$("#DelectButton").click(function() {
					$.ajax({url:"RecycleServlet?method=delect&id="+$("#id").val()
														+"&title="+$("#title").val()
														+"&path="+$("#path").val()
														+"&type="+$("#type").val()
														+"&time="+$("#time").val(),success:function(result){
				...
				$("#UpdataButton").click(function() {
					$.ajax({url:"RecycleServlet?method=updata&id="+$("#id").val()
														+"&title="+$("#title").val()
														+"&path="+$("#path").val()
														+"&type="+$("#type").val()
														+"&time="+$("#time").val(),success:function(result){
