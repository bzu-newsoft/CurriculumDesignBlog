...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() { 
				$.ajax({url:"MemberServlet?method=select",success:function(result){
					  //window.open("http://www.baidu.com");
				      $("#divSelectPublish").html(result);
				    }});
				$("#InsertButton").click(function() {
					$.ajax({url:"MemberServlet?method=insert&id="+$("#id").val()
														+"&name="+$("#name").val()
														+"&pass="+$("#pass").val(),success:function(result){
					     $("#spanChange").html(result);
					    }});
				});
				$("#DelectButton").click(function() {
					$.ajax({url:"MemberServlet?method=delect&id="+$("#id").val()
														+"&name="+$("#name").val()
														+"&pass="+$("#pass").val(),success:function(result){
					     $("#spanChange").html(result);
					    }});
				...
				$("#UpdataButton").click(function() {
					$.ajax({url:"MemberServlet?method=updata&id="+$("#id").val()
														+"&name="+$("#name").val()
														+"&pass="+$("#pass").val(),success:function(result){
					     $("#spanChange").html(result);
					    }});
