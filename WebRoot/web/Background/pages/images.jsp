...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() { 
				...
				$.ajax({url:"ImagesServlet?method=select",success:function(result){
					  //window.alert(result);
					  //window.open("http://www.baidu.com");
				      $("#divSelectPublish").html(result);
				    }});
				$("#InsertButton").click(function() {
					$.ajax({url:"ImagesServlet?method=insert&id="+$("#id").val()
														+"&title="+$("#title").val()
														+"&path="+$("#path").val()
														+"&content="+$("#content").val(),success:function(result){
					     $("#spanChange").html(result);
					    }});
				});
				$("#DelectButton").click(function() {
					$.ajax({url:"ImagesServlet?method=delect&id="+$("#id").val()
														+"&title="+$("#title").val()
														+"&path="+$("#path").val()
														+"&content="+$("#content").val(),success:function(result){
					     $("#spanChange").html(result);
				...
				$("#UpdataButton").click(function() {
					$.ajax({url:"ImagesServlet?method=updata&id="+$("#id").val()
														+"&title="+$("#title").val()
														+"&path="+$("#path").val()
														+"&content="+$("#content").val(),success:function(result){
					     $("#spanChange").html(result);
