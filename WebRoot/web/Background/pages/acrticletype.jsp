...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() { 
				...
				$.ajax({url:"AcrticleTypeServlet?method=select",success:function(result){
					  //window.alert(result);
					  //window.open("http://www.baidu.com");
				      $("#divSelectPublish").html(result);
				    }});
				$("#InsertButton").click(function() {
					$.ajax({url:"AcrticleTypeServlet?method=insert&id="+$("#id").val()
														+"&title="+$("#title").val()
														+"&type="+$("#type").val(),success:function(result){
					     $("#spanChange").html(result);
					    }});
				});
				$("#DelectButton").click(function() {
					$.ajax({url:"AcrticleTypeServlet?method=delect&id="+$("#id").val()
														+"&title="+$("#title").val()
														+"&type="+$("#type").val(),success:function(result){
					     $("#spanChange").html(result);
					    }});
				...
				$("#UpdataButton").click(function() {
					$.ajax({url:"AcrticleTypeServlet?method=updata&id="+$("#id").val()
														+"&title="+$("#title").val()
														+"&type="+$("#type").val(),success:function(result){
					     $("#spanChange").html(result);
					    }});
